...
public class BrandService {
    ...
    public List<Brands> findByBrName(String brName) { return brandRepo.findByBrNameContaining(brName);}
    ...
    public void updateBrandsById(Brands c) throws Exception {
        ...
        brands.setModifiedBy("1");
        brands.setModifiedDate(new Date());
    ...
    public void saveAllBrands(List<Brands> ls)
    {
        brandRepo.saveAll(ls);
    }
}
